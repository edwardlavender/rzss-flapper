...
2.  **`data/`** contains processed data:
      ...
      - `spatial/` contains processed spatial data:
          ...
          - `mesh/` contains processed WeStCOMS mesh files from `process_spatial.R` (see below); <br/><br/>
...
3. **Implement data analysis** via `analyse_fights.R`, `analyse_bloods.R`, `analyse_bloods_change.R` and `analyse_vitals.R`. 
